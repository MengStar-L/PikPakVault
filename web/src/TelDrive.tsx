...
import { EmptyState, ErrorState, FolderPicker, Loading, Modal, Status } from './components'
import './teldrive.css'
...
export default function TelDrivePage() {
  ...
  return <div className="scroll-page td-page">
    ...
    <div className="td-help"><CloudUpload size={18}/><p>传输经过服务器，会消耗服务器上下行流量。文件内容不长期落盘。源端删除不会删除云端副本，同名冲突或内容变化会暂停处理。切换账号后，后续扫描使用新账号；已有任务仍属于原账号。</p></div>
